  ...
  return (
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>With a focus on innovation, hands-on learning, and personalized mentorship, our programs prepare aspiring educators to made a meaningful impact in classrooms, schools, and communities.</p>
